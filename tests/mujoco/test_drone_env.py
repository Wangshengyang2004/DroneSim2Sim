...
from dronesim2sim.core.simulators.mujoco.drone_env import DroneEnv

def test_mujoco_env_initialization():
    """Test initialization of the MuJoCo drone environment."""
